...
public class Constants {
    ...
    public static class Drivetrain {
        ...
        public static final double MOVEMENT_MAX_ACCELERATION_METERS_PER_SECOND = 0.1d;

        // The amount of seconds it should take to accelerate from 0.0 to 1.0 radians per second
        public static final double TURNING_MAX_ACCELERATION_RADIANS_PER_SECOND = 0.1d;
